...
// Removed SplitText import to avoid dependency issues with paid plugins
// We will manually split text for animation
...
export default function Hero3D({
  ...
  useGSAP(
    () => {
      ...
      // Manual animation for words instead of SplitText
